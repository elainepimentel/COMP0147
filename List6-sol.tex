...
\item  the function that assigns to a binary string
...
\item \streasy (Rosen 2.3-33) Let $g$ be a function from $A$ to $B$
and $f$ a function from $B$ to $C$.

\begin{enumerate}
\item  Show that if $f$ and $g$ are both injective,
...
\item  Show that if $f$ and $g$ are both surjective,
