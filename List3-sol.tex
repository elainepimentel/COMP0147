...
\item \streasy (Rosen 1.1.9) Let $p$ and $q$ be the propositions \prop{Swimming is allowed on the coast of New Jersey} and \prop{Sharks have been sighted near the coast}, respectively.  
...
\solution{
\begin{enumerate}
\item $\neg{p} \vee q$: \prop{It is either the case that swimming is not allowed on the coast of New Jersey or that sharks have been sighted near the coast.}
\item $p \imp \neg{q}$: \prop{If swimming is allowed on the coast of New Jersey, then sharks have not been sighted near the coast.}
\item $p \doubleimp \neg{q}$: \prop{Swimming is allowed on the coast of New Jersey if and only if sharks have not been sighted near the coast.}
...
$q$ : It is safe to walk on the trail.\\
...
\item It is necessary to walk 8 miles to reach the top of Long's Peak.
...
\solution{
    %FIXME: It would be quite simpler with modular arithmetic.
\begin{enumerate}[(a)]
...
\solution{
    %FIXME: again, simpler with modular arithmetic.
\begin{enumerate}[(a)]
...
Clearly, saying that every British person is a man or a woman 
