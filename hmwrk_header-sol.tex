...
\newwatermark[allpages,color=blue!50,angle=45,scale=3,xpos=0,ypos=0]{\fontsize{50}{60}{\bf Answers} \\[1cm]\fontsize{20}{30}\bf {Not to be printed}}
...
\end{flushleft} 
\ \\
\textbf{\MakeUppercase{\strtypeofassignment\ \ifdefined\hidesolution \else \strsolution \fi
}}\\
\textsc{#1\\
(#2)}
\end{center}
